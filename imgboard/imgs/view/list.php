...
foreach ($this->data as $i){
	...
	print "</tr>";
	print "<tr>";
	print "<td colspan='2'><img src='".$i->getPath().
	...
	print "</tr>";
	print "<tr>";
	print " colspan='2' id='td_".$i->getId()."'>";
	foreach($i->getReps() as $r){
		print "content : ".$r->getContent()."/wdate:".$r->getWdate().
		"/writer:".$r->getWriter()."<br>";
	}
	print "</td>";
	print "</tr>";
	print "</table>";
...
foreach ($this->ids as $id){
	print "<a href='/web1/imgboard/imgs/index.php?action=list&writer="
		.$id."'>".$id."</a><br>";
}
?>
</div>

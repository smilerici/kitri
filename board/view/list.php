...
<head>
<style type="text/css">
#view{position:relative;top:-100px;left:250px;}
</style>
...
<?php
	foreach ($this->data as $a){
		...
		print "<td><a href='/web1/board/index.php?action=detail&num=".
				$a->getNum().
		"' onmouseover='viewArticle(".$a->getNum().
		")', onmouseout='clearArticle()'>".$a->getTitle()."</a></td>";
		print "<td>".$a->getWriter()."</td>";
		print "</tr>";
		foreach ($a->getReps() as $r){
			print "<tr>";
			print "<td>".$r->getNum()."</td>";
			print "<td><a href='/web1/board/index.php?action=detail&num=".
					$r->getNum().
					"' onmouseover='viewArticle(".$r->getNum().
					")', onmouseout='clearArticle()'>".$r->getTitle().
					"</a></td>";
			print "<td>".$r->getWriter()."</td>";
			print "</tr>";
...
<div id="view" style="display: none;width:200px;height:10px;"></div>
<h3>제목으로 검색</h3>
<form name="search1">
